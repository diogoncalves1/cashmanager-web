...
export async function onDeleteTransaction(id: string, table?: any, pagination?: any, mutate?: any) {
...
export async function onConfirmTransaction(id: string, mutate?: any) {
  const result = await Swal.fire({
